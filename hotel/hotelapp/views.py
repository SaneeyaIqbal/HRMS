...
class HotelListCreateBoth(generics.ListCreateAPIView):
...
class HotelListDelete(generics.DestroyAPIView):
    queryset = Hotel.objects.all()
    serializer_class = HotelSerializer


class HotelListUpdate(generics.UpdateAPIView):
    queryset = Hotel.objects.all()
    serializer_class = HotelSerializer
...
class ManagerListUpdate(generics.UpdateAPIView):
    queryset = Manager.objects.all()
    serializer_class = ManagerSerializer


class ManagerListDelete(generics.DestroyAPIView):
    queryset = Manager.objects.all()
    serializer_class = ManagerSerializer
...
class GuestListCreate(generics.CreateAPIView):
    queryset = Guest.objects.all()
    serializer_class = GuestSerializer

class GuestListUpdate(generics.UpdateAPIView):
    queryset = Guest.objects.all()
    serializer_class = GuestSerializer


class GuestListDelete(generics.DestroyAPIView):
    queryset = Guest.objects.all()
    serializer_class = GuestSerializer
...
#
# @api_view(['GET]', ])
# def api_booking_details_view(request,pk):
#     try:
